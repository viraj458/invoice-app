...
const InvoicePage: FC<Props> = ({ data, pdfMode, onChange }) => {
  ...
  // useEffect(() => {
  //   const paid = subTotal ? subTotal - invoice.paid : 0;
      ...
      <Page className="invoice-wrapper" pdfMode={pdfMode}>
        ...
        <View className="flex" pdfMode={pdfMode}>
          <View className="w-50" pdfMode={pdfMode}>
            ...
            <Text pdfMode={pdfMode}>Name</Text>
            <Text pdfMode={pdfMode}>Address</Text>
            <Text pdfMode={pdfMode}>City</Text>
            {/* <EditableInput
            ...
            <View className="flex" pdfMode={pdfMode}>
              ...
              <View className="w-50 p-5" pdfMode={pdfMode}>
                <EditableInput
                  ...
                  value={invoice.paid}
                  onChange={(value: string) => handleChange('paid', value)}
                  pdfMode={pdfMode}
                />
              </View>
            </View>
            <View className="flex" pdfMode={pdfMode}>
              <View className="rowTop w-50 p-5" pdfMode={pdfMode}>
                <Text className="bold right dark" pdfMode={pdfMode}>
                  Balance (LKR)
                </Text>
                {/* <EditableInput
                  className="bold"
              ...
              <View className="rowTop w-50 p-5" pdfMode={pdfMode}>
                ...
                /> */}
                <Text className="right bold dark" pdfMode={pdfMode}>
                  {(typeof subTotal !== 'undefined' ? subTotal - Number(invoice.paid) : 0).toFixed(2)}
                </Text>
              </View>
            </View>
          </View>
